...
function setSentrySpan(spanId, sentrySpan) {
  ...
  const rootSpanId = _optionalChain([getRootSpan, 'call', _ => _(sentrySpan), 'optionalAccess', _2 => _2.spanContext, 'call', _3 => _3(), 'access', _4 => _4.spanId]);
...
export { SPAN_MAP, clearSpan, getSentrySpan, setSentrySpan };
